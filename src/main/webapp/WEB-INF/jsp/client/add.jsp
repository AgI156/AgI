...
<head>
    ...
    <meta charset="utf-8">
    <title>添加客户信息</title>
    <link rel="stylesheet" href="assets/client/css/add.css">
...
<body>
<h1>添加客户信息</h1>
<form id="client-form" action="client/add" method="post">
    <div>
        <label for="">*卡号：</label>
